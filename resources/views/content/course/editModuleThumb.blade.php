...
<div class="container mx-auto p-3 mb-5 mx-auto bg-dark rounded-3 border border-primary shadow-lg" >
    <form id="thumb" action="{{route('putCourseModuleThumb',$module->id)}}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
    </form>
    ...
    <div class="input-group mb-3">
        ...
        <input form="thumb" type="file" name="thumb" class="form-control bg-dark text-white" placeholder="Escolher arquivollçkl" aria-label="" aria-describedby="basic-addon2" required accept=".jpg, png"><br>
    </div>
