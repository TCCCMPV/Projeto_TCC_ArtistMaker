...
<div class="container mx-auto p-3 mb-5 mx-auto bg-dark rounded-3 border border-primary shadow-lg">
    <form method="post" action="{{route('postCourse')}}" enctype="multipart/form-data">
        ...
        <div class="input-group mb-3 ">
            ...
            <input type="text" name="name" class="form-control bg-dark text-white" placeholder="Título"
                aria-label="Título" aria-describedby="basic-addon1" maxlength="100" required>
        </div>
        {{-- descrição --}}
        <div class="input-group mb-3">
            <span class="input-group-text bg-primary text-dark" id="basic-addon1">
            ...
            <textarea class="form-control form-control bg-dark text-white" name="desc" placeholder="Descrição"
                aria-label="Descrição" aria-describedby="basic-addon1" required maxlength="450"></textarea>
        </div>
        {{-- thumbnail --}}
        <div class="input-group mb-3">
        ...
        {{-- dificuldade --}}
        <div class="input-group mb-3">
            <label class="input-group-text bg-primary text-dark" for="inputGroupSelect01"><b>Nível de
                    dificuldade</b></label>
        ...
        <div class="input-group mb-3">
            ...
            <select name="subcategory" class="form-select bg-dark text-white" id="inputGroupSelect01" required>
                ...
                <option class="bg-dark text-white" value="{{$subcategory->id}}" for="quali1">
                    {{ucfirst($subcategory->category->id)}}: {{ucfirst($subcategory->id)}}
                </option>
                @endforeach
