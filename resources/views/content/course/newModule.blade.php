    ...
    <form  method="post" action="{{route('postModule')}}" enctype="multipart/form-data">
        ...
        <div class="input-group mb-3 ">
          ...
          <div class="input-group mb-3">
            ...
            <textarea class="form-control form-control bg-dark text-white" name="desc"  placeholder="Descrição" aria-label="Descrição" aria-describedby="basic-addon1" required maxlength="500"></textarea>
          </div>
          <div class="input-group mb-3">
