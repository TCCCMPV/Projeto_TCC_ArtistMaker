    ...
    <form id="text" action="{{route('insertTutorialText',$id)}}" method="POST" enctype="multipart/form-data">
        ...
        <div class="input-group mb-3">
            ...
            <textarea class="form-control form-control bg-dark text-white" form="text" name="text"
                placeholder="Texto..." aria-label="Texto..." aria-describedby="basic-addon1" required
        ...
        <div class="input-group mb-3 ">
            ...
            <input type="number" name="position" form="text" class="form-control bg-dark text-white"
