    ...
    <form id="video" action="{{route('insertTutorialVideo',$id)}}" method="POST" enctype="multipart/form-data">
        ...
        <div class="input-group mb-3">
            ...
            <input form="video" type="file" name="video" class="form-control bg-dark text-white"
                placeholder="Escolher arquivo" aria-label="" aria-describedby="basic-addon2" required accept=".mp4">
            <br>
        </div>
        {{-- posição --}}
        <div class="input-group mb-3 ">
            ...
            <input type="number" name="position" form="video" class="form-control bg-dark text-white"
                placeholder="Posição" aria-label="Posição" aria-describedby="basic-addon1" min="1" required>
        </div>
        {{-- submit --}}
        <div class="d-grid gap-2">
            <button class="btn btn-primary text-dark" form="video" type="submit">
                <b>Enviar</b>
            </button>
        </div>
    </form>
