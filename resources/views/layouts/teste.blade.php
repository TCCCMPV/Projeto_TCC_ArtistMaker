...
<body>
    ...
    <a target="_blank"  href="{{ route('user', auth::id()) }}">
    <div class="d-grid gap-2">
        <button class="btn btn-outline-danger" type="button" >  LIXO
...
<div class="dropdown">
    ...
    <ul class="dropdown-menu dropdown-menu-dark" aria-labelledby="dropdownMenuButton2">
      ...
      <li><a class="dropdown-item" href="#">Agroboy</a></li>
      <li><hr class="dropdown-divider"></li>
      <li><a class="dropdown-item" href="https://discord.com/">Discord
      ...
      <li><a class="dropdown-item" href="https://github.com/cauanbastos">GitHub 
